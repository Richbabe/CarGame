...
{
	// 如果指定了.mbo文件且.mbo文件存在，优先读取.mbo文件
...
bool ObjReader::ReadObj(const wchar_t * objFileName)
{
	...
	std::vector<XMFLOAT3>   positions;  // 保存顶点坐标
	std::vector<XMFLOAT3>   normals;    // 保存法向量
	std::vector<XMFLOAT2>   texCoords;  // 保存纹理坐标
